...
## Overview
Hybrid B2C/B2B Gym Management SaaS. B2C: workout logging + progress charts.
...
- `gym_admin` — Manages one gym. Members, attendance, QR, analytics, settings.
- `member` — End user. Logs workouts, tracks progress, QR check-in.
...
atom-os/
  apps/api/src/           # Express backend
    ...
    routes/               # admin, auth, checkins, gyms, membership, qr, workouts
  ...
  apps/web/src/           # React frontend
    ...
    pages/member/         # Dashboard, Workouts, Progress, Checkin, Profile
...
## Status: v1.3.0 — COMPLETE — 48 files / 6,882 lines / 0 TS errors
